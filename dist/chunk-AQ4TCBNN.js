...
function Body(decoratorProps) {
  const schema = "schema" in decoratorProps ? decoratorProps.schema : decoratorProps;
  const headers = "schema" in decoratorProps ? decoratorProps.headers || ["application/json"] : ["application/json"];
